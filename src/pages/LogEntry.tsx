        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 glass-card rounded-xl p-6">
            ...
            <div className="mt-6 space-y-4">
              ...
              <button
                className="w-full py-3 rounded-lg font-heading font-600 transition-all text-foreground"
                style={{
                  backgroundColor: `${activeColor}20`,
                  boxShadow: `0 0 30px ${activeColor}15`,
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.boxShadow = `0 0 40px ${activeColor}30`;
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.boxShadow = `0 0 30px ${activeColor}15`;
                }}
              >
                Log Entry
              </button>
          ...
          <div className="glass-card rounded-xl p-6 flex flex-col items-center justify-center h-fit sticky top-20">
            ...
            >
              <span className="font-mono text-4xl font-bold" style={{ color: activeColor }}>
            ...
            <div className="mt-6 w-full h-1.5 rounded-full bg-muted overflow-hidden">
              <motion.div
                ...
                animate={{ width: `${Math.min((co2Estimate / 10) * 100, 100)}%` }}
                style={{
            ...
            <div className="mt-6 relative w-28 h-28">
              <svg viewBox="0 0 100 100" className="w-full h-full -rotate-90">
                ...
                <motion.circle
                  ...
                  animate={{ strokeDashoffset: 264 - (Math.min(co2Estimate / 10, 1) * 264) }}
